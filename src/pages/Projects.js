...
{/* project1 */}
                <div class="row flex-row align-items-center gap100">
                    <div id="description" class="col-lg-5 col-md-6 col-sm-12">
                    ...
                    <div class="col-lg-7 col-md-6 col-sm-12">
                        ...
                        <img class="img-fluid shadow-sm p-3 bg-body rounded bg-body rounded" id="pIMG" src="/images/project1.png" alt="Project1" />
                        </a>
                    </div>
                </div>
{/* project2 */}
                <div class="row flex-row align-items-center gap100">
                    ...
                    <div class="col-lg-7 col-md-6 col-sm-12">
                        <a href="https://quiet-scrubland-19641.herokuapp.com/" target="_blank" rel="noreferrer">
                        <img class="img-fluid shadow-sm p-3 bg-body rounded bg-body rounded" id="pIMG" src="/images/project2.png" alt="Project2" />
                        </a>
                    </div>
                </div>
{/* project3 */}
                <div class="row gap100">
                    ...
                    <div class="col-lg-7 col-md-6 col-sm-12">
                        <a class="text-decoration-none" href="https://sports-team-builder.netlify.app/" target="_blank" rel="noreferrer">
                            <img class="img-fluid shadow-sm p-3 bg-body rounded bg-body rounded" id="pIMG" src="/images/project3.png" alt="Project3" />
                        </a>
                    </div>
                </div>
{/* project4 */}
                <div class="row gap100">
                    ...
                    <div class="col-lg-7 col-md-6 col-sm-12">
                        <a href="https://radiant-chamber-29667.herokuapp.com/" target="_blank" rel="noreferrer">
                        <img class="img-fluid shadow-sm p-3 bg-body rounded bg-body rounded" id="pIMG" src="/images/project4.png" alt="Project1" />
                        </a>
                    </div>
                </div>
{/* project5 */}
                ...
                <div class="row gap100">
                    ...
                    <div class="col-lg-7 col-md-6 col-sm-12">
                        <a href="https://www.behance.net/gallery/121996489/TRAFFIC" target="_blank" rel="noreferrer">
                            <img class="img-fluid shadow-sm p-3 bg-body rounded bg-body rounded" id="pIMG" src="/images/project5.png" alt="Project5" />
                        </a>
                    </div>
                </div>
{/* project6 */}
                <div class="row">
                    ...
                    <div class="col-lg-7 col-md-6 col-sm-12">
                        <img class="img-fluid shadow-sm p-3 bg-body rounded bg-body rounded" id="pIMG" src="/images/project6.png" alt="Project1" />
                    </div>
                </div>
{/* project7 */}
                <div class="row gap100">
                    <div id="description" class="col-lg-5 col-md-6 col-sm-12">
                        <p class="text-start" id="pnotes">hobby and learning</p>
                            <a class="text-decoration-none" href="https://www.behance.net/gallery/112376301/Illustrator-Practice" target="_blank" rel="noreferrer">
                    ...
                    <div class="col-lg-7 col-md-6 col-sm-12">
                        <a class="text-decoration-none" href="https://www.behance.net/gallery/112376301/Illustrator-Practice" target="_blank" rel="noreferrer">
                            <img class="img-fluid shadow-sm p-3 bg-body rounded bg-body rounded" id="pIMG" src="/images/project7.png" alt="Project7" />
                        </a>
                    </div>
                </div>
            </div>
